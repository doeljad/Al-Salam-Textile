...
$sheet->setTitle('Laporan Pembelian Bulan ' . $nama_bulan_dipilih);
...
header('Content-Disposition: attachment;filename="Laporan Pembelian Bulan ' . $nama_bulan_dipilih . '.xlsx"');
